package com.study.soulx.design_patterns.my.some.action.strategy.util;
...
public class ClassScaner{
    ...
    public static void main(String[] args) {
        Set<Class<?>> scan = ClassScaner.scan("com.study.soulx.design_patterns.my.some.action.strategy.model");
        for (Class<?> c:scan) {
